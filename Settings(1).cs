    ...
    class Settings
    {
        ...
        private Settings()
        {
            ...
            logicOperations = new Dictionary<string, Tuple<string, int>>{
                ...
                { "and",    new Tuple<string, int>("and",   2)},
                { "nand",   new Tuple<string, int>("nand",  2)},
                { "or",     new Tuple<string, int>("or",    1)},
                { "nor",    new Tuple<string, int>("nor",   1)},
                { "not",    new Tuple<string, int>("not",   3)},
                { "xor",    new Tuple<string, int>("xor",   2)},
                { "xnor",   new Tuple<string, int>("xnor",  2)}
            };
