    ...
    public class Settings
    {
        ...
        private Settings()
        {
            ...
            logicOperations = new Dictionary<string, Tuple<string, int>>{
                ...
                { "and",    new Tuple<string, int>("*",   4)},
                { "nand",   new Tuple<string, int>("|",  3)},
                { "or",     new Tuple<string, int>("+",    2)},
                { "nor",    new Tuple<string, int>("#",   1)},
                { "not",    new Tuple<string, int>("!",   7)},
                { "buf",    new Tuple<string, int>("buf",   8)},
                { "xor",    new Tuple<string, int>("^",   6)},
